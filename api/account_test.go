...
func TestGetAccountAPI(t *testing.T) {
	...
	testCases := []struct {
		...
		// TODO: Agregar mas casos (si existen)
	}
...
func randomAccount(owner string) db.Cuentum {
	return db.Cuentum{
...
func requireBodyMatchAccount(t *testing.T, body *bytes.Buffer, account db.Cuentum) {
	...
	var gotAccount db.Cuentum
	err = json.Unmarshal(data, &gotAccount)
	require.NoError(t, err)
	require.Equal(t, account, gotAccount)
}

func requireBodyMatchAccounts(t *testing.T, body *bytes.Buffer, accounts []db.Cuentum) {
	data, err := ioutil.ReadAll(body)
	require.NoError(t, err)

	var gotAccounts []db.Cuentum
