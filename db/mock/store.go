...
// Source: github.com/jdiego0102/gobank/db/sqlc (interfaces: Store)
...
func (m *MockStore) AddAccountBalance(arg0 context.Context, arg1 db.AddAccountBalanceParams) (db.Cuentum, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "AddAccountBalance", arg0, arg1)
	ret0, _ := ret[0].(db.Cuentum)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateAccount(arg0 context.Context, arg1 db.CreateAccountParams) (db.Cuentum, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) CreateEntry(arg0 context.Context, arg1 db.CreateEntryParams) (db.Ingreso, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEntry", arg0, arg1)
	ret0, _ := ret[0].(db.Ingreso)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateTransfer(arg0 context.Context, arg1 db.CreateTransferParams) (db.Transferencium, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTransfer", arg0, arg1)
	ret0, _ := ret[0].(db.Transferencium)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetAccount(arg0 context.Context, arg1 int64) (db.Cuentum, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetAccountForUpdate(arg0 context.Context, arg1 int64) (db.Cuentum, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEntry(arg0 context.Context, arg1 int64) (db.Ingreso, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTransfer(arg0 context.Context, arg1 int64) (db.Transferencium, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAccounts(arg0 context.Context, arg1 db.ListAccountsParams) ([]db.Cuentum, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEntries(arg0 context.Context, arg1 db.ListEntriesParams) ([]db.Ingreso, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTransfers(arg0 context.Context, arg1 db.ListTransfersParams) ([]db.Transferencium, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAccount(arg0 context.Context, arg1 db.UpdateAccountParams) (db.Cuentum, error) {
	m.ctrl.T.Helper()
